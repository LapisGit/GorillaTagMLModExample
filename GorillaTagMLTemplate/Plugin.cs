using MelonLoader;
using GorillaTagMLTemplate;
using GorillaTagMLTemplate.Tools;
using UnityEngine;

// !!!
// NOTE: When you build the project, your IDE will automatically try to move the compiled DLL to the Mods folder, with the name of GorillaTagMLTemplate.dll/GorillaTagMLTemplate.pdb. If you change the name of the project, make sure to change the name of the DLL in the .csproj file.
// !!!
...
[assembly: MelonInfo(typeof(YourModClass), "GorillaTagMLTemplate", "1.0.0", "Lapis")]
